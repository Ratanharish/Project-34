...
function setup() 
{
  ...
  bunny = createSprite(1220,520,100,100);
  bunny.scale = 0.2;
  ...
  star2= createSprite(150,330,20,20)
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=1250)
  {
...
function airblow(){
   Matter.Body.applyForce(fruit,{x:0,y:0},{x:0.05,y:-0.03})
   air.play()
}
